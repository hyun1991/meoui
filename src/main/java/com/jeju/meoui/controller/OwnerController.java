...
public class OwnerController {
	...
	//	업주 상세뷰(미완료)
	@RequestMapping(value="/manage/view/{ownerId}", method=RequestMethod.GET)
	...
	public String ownerList(Model model, @RequestParam(defaultValue="1") int pageNo){
		model.addAttribute("result", service.getAllOwner(pageNo));
		return "owner/list";
	}
}
