...
<%@include file="/nav/ownernav.jsp" %>
	<h1>숙박시설 수정페이지</h1>
	<hr>
	<form action="/meoui/manage/accommodation/update" method="post" enctype="multipart/form-data">
		<hr>
		<div>
			...
			<div class="btn-group">
				<input type="submit" value="숙박업소 수정" id="confirmBtn" class="btn btn-primary">
