		...
		<div class="row">
			<div class="col-md-4">
				<c:forEach items="${result.list }" var="reserve">
					...
					<label for="usr">주소:</label>${reserve.accommodationAddress }<br>
					<label for="usr">연락처:</label>${reserve.accommodationPhone }<br>
					<div class="form-group">
						<a href="/meoui/reserve/delete/${reserve.reserveNo }"><button
