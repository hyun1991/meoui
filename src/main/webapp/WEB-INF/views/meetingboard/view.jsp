	...
	<div class="row text-center">
		...
		<h2>모임게시판 댓글 목록</h2>	
				...
				<p>댓글 번호 : ${list.meetingboardCommentNo }</p>
					...
					<p>
						<fmt:formatDate value="${list.meetingboardCommentDate}" pattern="yyyy년MM월dd일"/>
					</p>					
					<p>
					
					<form action="/meoui/metingcomment/delete/${list.meetingboardCommentNo }" method="POST">
					<button id="commit" type="submit">댓글 삭제</button><br><br><br>
					</form>
				...
				<form action="/meoui/metingcomment/insert" method="POST">
					<input type="text"	id="meetingboardCommentContent" name="meetingboardCommentContent">
