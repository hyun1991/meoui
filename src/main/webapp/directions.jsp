...
<body>
	...
	<div>
		<input id="origin-input" class="controls" type="text"
			placeholder="출발지를 입력하세요"> <input id="destination-input"
			class="controls" type="text" placeholder="도착지를 입력하세요"> <input
			type="submit" id="submit" class="controls" value="길찾기">
	</div>

	<div id="right-panel">
		<p>
			총거리: <span id="total"></span>
		</p>
	</div>
</body>
	<script>
		function initMap() {
			...
			displayRoute(origin - input.val(), destination - input.val(),
