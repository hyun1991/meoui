	...
	<div class="container-fluid text-center">
		<div class="row">
			<ul class="nav nav-tabs" id="menu">
				...
				<li class="col-md-3"><a data-toggle="tab" href="/meoui/admin_aboutUser.jsp">숙박등록<span class="badge">5</span>
				</a></li>
				<li class="col-md-3"><a data-toggle="tab" href="/meoui/admin_aboutUserInfo.jsp"
					alt="잠수함/유람선/레저" id="레저">숙박관리<span class="badge">5</span></a></li>
				<li class="col-md-3"><a data-toggle="tab" href="#theater">숙박시설댓글검색<span
						class="badge">5</span></a></li>
				<li class="col-md-3"><a data-toggle="tab" href="#musuem">숙박시설댓글조회<span
						class="badge">5</span></a></li>
