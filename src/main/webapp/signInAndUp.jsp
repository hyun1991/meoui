					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group step1">
								<label for="usr">아이디</label><br> <input type="text"
									class="form-control" id="checkId" name="memberId">
									<input type="button" class="btn btn-default" id="checkbtn" 
									value="아이디 중복확인">
							</div>
							...
							<div class="form-group step3">
								<label for="gender">성별</label><br> <label class="radio-inline"><input
									type="radio" name="memberGender" value="남자">남자</label> <label
